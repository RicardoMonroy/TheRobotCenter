            ...
            <ul>	<!-- SLIDE  -->
                ...
                data-description="Science says that Women are generally happier">
                    ...
                    <div class="tp-caption Newspaper-Subtitle   tp-resizeme"
                        ...
                        style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;">
                        {{-- {{ $page->secondText }} --}}
                        Mayores informes en: <a href="http://www.therobotcenter.com/encuentro-mentes-brillantes" target="_blank" style="color:#ffffff">Página Oficial de TheRobotCenter</a>
                    </div>
                    <!-- LAYER NR. 4 -->
                    <div class="tp-caption Newspaper-Button rev-btn "
                        id="slide-200-layer-5"
...
<div class="content-block">
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="service-bx">
                        ...
                        <div class="info-bx text-center">
                            ...
                            <h4><a href="#">Solicitar Empleo como Educador</a></h4>
                            <a href="#" class="btn radius-xl">Ver más</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center text-white">
                    <h2>¿Te interesa aprender Robótica?</h2>
                    <h5>Dejanos tu dirección de email y nosotros te contactamos</h5>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <div class="cours-search-bx m-b30">
                            <div class="icon-box">
                                <h3><i class="ti-user"></i><span class="counter">1</span>m</h3>
                            </div>
                            <span class="cours-search-text">Hasta 1 mil alumnos</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
                        <div class="cours-search-bx m-b30">
                            <div class="icon-box">
                                <h3><i class="ti-book"></i><span class="counter">30</span>.</h3>
                            </div>
                            <span class="cours-search-text">30 Cursos.</span>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="cours-search-bx m-b30">
                            <div class="icon-box">
                                <h3><i class="ti-layout-list-post"></i><span class="counter">8</span>K</h3>
                            </div>
                            <span class="cours-search-text">Documentos Online.</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center heading-bx">
                    <h2 class="title-head m-b0">Eventos <span>Próximos</span></h2>
                    <p class="m-b0">Te mantenemos al tanto de lo que pasa en nuestro entorno robótico. </p>
                </div>
            </div>
            <div class="row">
                    ...
                    <div class="event-bx">
                        ...
                        <div class="info-bx d-flex">
                            ...
                            <div class="event-info">
                                <h4 class="event-title"><a href="#">Education Tour 2019</a></h4>
                                <ul class="media-post">
                                    <li><a href="#"><i class="fa fa-clock-o"></i> 7:00am 8:00am</a></li>
                                    <li><a href="#"><i class="fa fa-map-marker"></i> CDMX</a></li>
                                </ul>
                    ...
                    <div class="event-bx">
                        ...
                        <div class="info-bx d-flex">
                            ...
                            <div class="event-info">
                                ...
                                <ul class="media-post">
                                    <li><a href="#"><i class="fa fa-clock-o"></i> 7:00am 8:00am</a></li>
                                    <li><a href="#"><i class="fa fa-map-marker"></i> Querétaro, México</a></li>
                                </ul>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the..</p>
                            </div>
                        </div>
                    ...
                    <div class="event-bx">
                        ...
                        <div class="info-bx d-flex">
                            ...
                            <div class="event-info">
                                ...
                                <ul class="media-post">
                                    <li><a href="#"><i class="fa fa-clock-o"></i> 7:00am 8:00am</a></li>
                                    <li><a href="#"><i class="fa fa-map-marker"></i> Mty, México</a></li>
                                </ul>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the..</p>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-white heading-bx left">
                    <h2 class="title-head text-uppercase">¿Qué dicen <span>de nosotros?</span></h2>
                    <p>Nadie mejor que personas como tú para expresar lo que somos...</p>
                </div>
            </div>
                ...
                <div class="item">
                    <div class="testimonial-bx">
                        ...
                        <div class="testimonial-info">
                            <h5 class="name">BILL CHURCH</h5>
                            <p>-Perfil Jr / Sr High School, Bethlehem, NH</p>
                        </div>
                        <div class="testimonial-content">
                            <p>Aprender a codificar a través de LEGO ® ofrece a los estudiantes la oportunidad de utilizar una herramienta de resolución de problemas físicos en sus ejercicios de codificación. Su código cobra vida en formas que pueden ver, oír, tocar e incluso perseguir a través de la habitación.</p>
                        </div>
                    </div>
                </div>
                <div class="item">
    ...
    {{-- <div class="section-area section-sp2">
        <div class="container">
            <div class="row">
                <div class="col-md-12 heading-bx left">
                    <h2 class="title-head">Ultimas <span>Noticias</span></h2>
                    <p>Suscríbete a nuestro blog y tendrás las entradas mas enriquecedoras sobre el mundo de la Robótica</p>
                </div>
            </div>
                    ...
                    <div class="recent-news">
                        ...
                        <div class="info-bx">
                            <ul class="media-post">
                                ...
                                <li><a href="#"><i class="fa fa-user"></i>Por Abelardo</a></li>
                            </ul>
                            <h5 class="post-title"><a href="blog-details.html">Estudiante gana concurso de robótica estatal.</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type...</p>
                            <div class="post-extra">
                                <a href="#" class="btn-link">Nota completa</a>
                                <a href="#" class="comments-bx"><i class="fa fa-comments-o"></i>20 Comentarios</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="recent-news">
                        ...
                        <div class="info-bx">
                            <ul class="media-post">
                                ...
                                <li><a href="#"><i class="fa fa-user"></i>Por Ricardo</a></li>
                            </ul>
                            <h5 class="post-title"><a href="blog-details.html">Se abre convocatorial para concurso de Robótica</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type...</p>
                            <div class="post-extra">
                                <a href="#" class="btn-link">Nota completa</a>
                                <a href="#" class="comments-bx"><i class="fa fa-comments-o"></i>14 Comentarios</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="item">
                    <div class="recent-news">
                        ...
                        <div class="info-bx">
                            ...
                            <h5 class="post-title"><a href="blog-details.html">LEGO presenta nuevos gadgets</a></h5>
                            <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type...</p>
                            <div class="post-extra">
                                <a href="#" class="btn-link">Nota completa</a>
                                <a href="#" class="comments-bx"><i class="fa fa-comments-o"></i>23 Comentarios</a>
                            </div>
                        </div>
                    </div>
                </div>
